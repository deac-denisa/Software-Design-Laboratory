...
public class Stay extends Vacation {
    ...
    public Stay(String name, VacationType type, String description, String location, double price, LocalDate startDate, LocalDate endDate) {
        super(name, VacationType.STAY, description, location, price, startDate, endDate);
    }
}
