...
INSERT INTO vacation (dtype, name, type, description, location, price, start_date, end_date, available_seats) VALUES
    ('Cruise', 'Caribbean Cruise',0, 'Cruise through the beautiful Caribbean islands', 'Caribbean', 1000.00, '2023-05-01', '2023-05-08', 100);
INSERT INTO vacation (dtype, name, type, description, location, price, start_date, end_date, available_seats) VALUES
    ('Stay', 'Safari Adventure', 1, 'Experience the African wilderness on a thrilling safari', 'Africa', 2000.00, '2023-06-01', '2023-06-08', 130);
INSERT INTO vacation (dtype, name, type, description, location, price, start_date, end_date, available_seats) VALUES
    ('Tour', 'Tour in Italy', 2,'Visiting museums', 'Italy', 800.00, '2023-06-02', '2023-06-10', 20);
...
INSERT INTO reservation (client_id, vacation_id, nr_seats) VALUES  (3, 1, 2), (3, 2, 21);
